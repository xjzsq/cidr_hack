...
class Handlers
{
    ...
    */
    ...
    static function OnBeforeResponse(oSession: Session) {
        ...
        if(oSession.uriContains("https://gateway.vocabgo.com/Student/StudyTask/SubmitAnswerAndSave")){
            oSession.utilDecodeResponse();
            oSession.SaveResponse("c:/cdr/response.txt",true);
            oSession.SaveResponseBody("c:/cdr/responseBody.txt");
        }
        if(oSession.uriContains("https://gateway.vocabgo.com/Student/StudyTask/SkipAnswer")){
            oSession.utilDecodeResponse();
            oSession.SaveResponse("c:/cdr/response.txt",true);
            oSession.SaveResponseBody("c:/cdr/responseBody.txt");
        }
        ...
        if(oSession.uriContains("https://gateway.vocabgo.com/Student/ClassTask/SkipAnswer")){
            oSession.utilDecodeResponse();
            oSession.SaveResponse("c:/cdr/response.txt",true);
            oSession.SaveResponseBody("c:/cdr/responseBody.txt");
        }
